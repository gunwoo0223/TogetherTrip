  ...
  <section id="container" >
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Festival Form</h3>
              ...
              <!--festival form-->        
              <form id="festival" action="festivalInsert.do" method="post" enctype="multipart/form-data">
				<div class="form-group" style=""> <!-- title field -->
					<label class="control-label" for="f_title">제목</label>
					<input class="form-control" id="f_title" name="f_title" type="text"/>
				</div>
				<div class="form-group"> <!-- loc field -->
					<label class="control-label " for="f_loc">위치</label>
					<input class="form-control" id="f_loc" name="f_loc" type="text" placeholder="정확한 주소와 띄어쓰기를 해주세요"/>
				</div>
			...
			<div class="col-xs-2">
				...
				<div class="form-group"> <!-- time field -->
					...
					<input class="form-control" id="f_time" name="f_time" type="text"/>
				</div>
		
				<div class="form-group"> <!-- tel field -->
					<label class="control-label " for="f_tel">문의/안내</label>
					<input class="form-control" id="f_tel" name="f_tel" type="text"/>
				</div>
				<div class="form-group"> <!-- contents field -->
					<label class="control-label " for="f_contents">내용</label>
					<textarea class="form-control" cols="40" id="f_contents" name="f_contents" rows="10"></textarea>
				</div>
				...
				<div class="form-group">
					<button class="btn btn-primary" id="festivalInsertBtn" name="submit" type="submit">확인</button>
				</div>
