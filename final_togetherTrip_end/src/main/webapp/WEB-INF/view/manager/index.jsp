...
<html lang="en">
  ...
  <script src="https://code.jquery.com/jquery-1.10.2.js"></script>
	...
	$(document).ready(function(){
		...
		$('.sidebar-menu a:eq(1)').addClass('active');
	});
	</script>  
  </head>
  ...
  <section id="container" >
      ...
      <section id="main-content">
          ...
          <h3><i class="fa fa-angle-right"></i>&nbsp;웹사이트 현황</h3>
              <!-- page start-->
              <div id="morris">
                  <div class="row mt">
                      <div class="col-lg-6">
                          <div class="content-panel">
                              <h4><i class="fa fa-angle-right"></i>&nbsp;회원수</h4>
                      ...
                      <div class="col-lg-6">
                          <div class="content-panel">
                              <h4><i class="fa fa-angle-right"></i>&nbsp;게시글 수</h4>
                              <div class="panel-body">
                  ...
                  <div class="row mt">
                      ...
                      <div class="col-lg-6">
                          <div class="content-panel">
                              <h4><i class="fa fa-angle-right"></i>&nbsp;인기 게시글</h4>
                              <div class="panel-body">
    ...
    <script src="manager/js/morris-conf.js"></script>
