  ...
  <section id="container" >
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Place Form</h3>
         	...
         	<!--place form-->
			 <form id="place" action="placeInsert.do" method="post" enctype="multipart/form-data">
				<div class="form-group" style=""> <!-- title field -->
					<label class="control-label" for="p_title">제목</label>
					<input class="form-control" id="p_title" name="p_title" type="text"/>
				</div>
				<div class="form-group"> <!-- loc field -->
					<label class="control-label " for="p_loc">위치</label>
					<input class="form-control" id="p_loc" name="p_loc" type="text" placeholder="정확한 주소와 띄어쓰기를 해주세요"/>
				</div>
			...
			<div class="col-xs-2">
				...
				<div class="form-group" > <!-- time field -->
					...
					<input class="form-control" id="p_time" name="p_time" type="text"/>
				</div>
				<div class="form-group"> <!--holiday field -->
					<label class="control-label " for="p_holiday">휴무일</label>
					<input class="form-control" id="p_holiday" name="p_holiday" type="text"/>
				</div>
				<div class="form-group"> <!-- tel field -->
					<label class="control-label " for="p_tel">문의/안내</label>
					<input class="form-control" id="p_tel" name="p_tel" type="text"/>
				</div>
				<div class="form-group"> <!-- contents field -->
					<label class="control-label " for="p_contents">내용</label>
					<textarea class="form-control" cols="40" id="p_contents" name="p_contents" rows="10"></textarea>
				</div>
				...
				<div class="form-group">
					<button class="btn btn-primary" id="placeInsertBtn" name="submit" type="submit">확인</button>
				</div>
